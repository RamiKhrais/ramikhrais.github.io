...
contains:null,skip:!0})]}]}}}());hljs.registerLanguage("sql",function(){"use strict";return function(e){
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}}());hljs.registerLanguage("python",function(){"use strict";return function(e){
const n={
...
begin:/^\.\.\.(?=[ ]|$)/}]}]}}}());hljs.registerLanguage("markdown",function(){"use strict";return function(n){
...
begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}}());hljs.registerLanguage("json",function(){"use strict";return function(n){var e={
...
name:"JSON",contains:t,keywords:e,illegal:"\\S"}}}());hljs.registerLanguage("r",function(){"use strict";return function(e){
